...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  final GlobalKey<State<PrivateRoomsSection>> _privateRoomsKey = GlobalKey<State<PrivateRoomsSection>>();
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const DebugUsersScreen(),
                                    ),
                                  );
                                },
                              ),
                          ...
                          builder: (context, child) {
                            return Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () async {
                                  debugPrint('=== PRIVATE ROOMS DEBUG BUTTON PRESSED ===');
                                  try {
                                    final privateRoomsState = _privateRoomsKey.currentState;
                                    if (privateRoomsState != null) {
                                      debugPrint('Refreshing Private Rooms section...');
                                      await (privateRoomsState as dynamic).refresh();
                                      debugPrint('Private Rooms refresh completed');
                                    } else {
                                      debugPrint('Private Rooms state is null');
                                    }
                                  } catch (e) {
                                    debugPrint('Error refreshing Private Rooms: $e');
                                  }
                                  debugPrint('=== PRIVATE ROOMS DEBUG COMPLETE ===');
                                },
                              ),
                            );
                          },
                    ...
                    return Container(
                      ...
                      child: TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const ChatsScreen(focusOnPrivateRooms: true)),
                          );
                        },
                        style: TextButton.styleFrom(
                          padding: const EdgeInsets.symmetric(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildStatItem('Total Users', stats['total'] ?? 0, Icons.people),
                        _buildStatItem('New Today', stats['today'] ?? 0, Icons.today),
                        _buildStatItem('This Week', stats['thisWeek'] ?? 0, Icons.date_range),
                      ],
                    ),
                  ],
                ),
