...
class _WantsScreenState extends State<WantsScreen>
  ...
  final Set<String> _selectedWants = {};
  ...
  // List of want options
  final List<String> _wantOptions = [
    'Love',
    'Friendship',
    'Adventure',
    'Motivation',
  ...
  void _submitWants() async {
    if (_selectedWants.isEmpty) {
    ...
    try {
      // Update user with wants
      final userService = UserService();
      await userService.updateUserProfile(
        userId: widget.userId,
        wants: _selectedWants.join(', '),
      );

      if (mounted) {
        // Navigate to needs screen instead of home
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: _wantOptions.map((option) {
                          final isSelected = _selectedWants.contains(option);
                          return GestureDetector(
                            onTap: () {
                              setState(() {
                                // Toggle selection
                                if (isSelected) {
                                  _selectedWants.remove(option);
                                } else {
                                  _selectedWants.add(option);
                                }
                              });
                            },
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: _isSubmitting ? null : _submitWants,
